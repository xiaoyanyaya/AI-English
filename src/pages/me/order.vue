<template>
  <view class="body pb-5" :style="bodyStyle">
    ...
    <view v-if="orderContent.length" class="px-3">
      <view
        class="px-3 pt-3 mt-4 pb-4 bg-white radio-10"
        v-for="(data, dataIndex) in orderContent"
        :key="dataIndex"
      >
          ...
          <view class="flex align-item-center">
            ...
            <view class="flex align-item-end">
              ...
              <view class="t-size-22 t-color-8A8A8A">
                (MID:{{ data.userInfo.memberNo }})</view
              >
            </view>
          </view>
          <view class="t-color-1863E5 mr-3"> 已付款 </view>
        </view>
            ...
            <view class="flex align-item-center justify-content-between mt-2">
              ...
              <view v-if="index === 3" class="flex align-item-center recomment">
                ...
                <view class="t-size-28">{{
                  getNameWithEllipsis(item.nickName, 10)
                }}</view>
              </view>
    ...
    <view v-else class="nodata_img">
      <image :src="`${imageBaseUrl}/nodata.png`"></image>
    </view>
  </view>
</template>
<script>
