  ...
  methods: {
    ...
    testRequestTask() {
      const requestTask = uni.request({
        url: `${apiDomain}composition/aigc/title2`,
        timeout: 15000,
        responseType: 'text',
        method: 'POST',
        ...
        header: {
          'X-Access-Token': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE3MDk3OTc0MjMsInVzZXJuYW1lIjoiYWRtaW4ifQ.NYF8EuOOU9vd1xKt0KvrSPjA-j2WvoNGO5xewmTRb6k'
        },
        success: response => {
        },
        fail: error => {
      ...
      /*requestTask.onChunkReceived(function(res) {
        ...
        // console.log(text.replaceAll("data:",""));
        console.log("text========================="+text.replace("data:",""));
      })*/
    },
  },
}
