...
export default class signMd5Utils {
  ...
  static getSign(url, requestParams) {
    ...
    let jsonObj = this.mergeObject(urlParams, requestParams); //console.log("sign jsonObj: ",jsonObj)
    ...
    return md5(noMassData + signatureSecret).toUpperCase();
  }
  ...
  // 	// console.log("sign requestBody: ", signatureSecret)
