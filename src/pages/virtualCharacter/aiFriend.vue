<template>
  <view class="">
    <cy-navbar showBack>
      <view class="t-size-30">形象选择</view>
    </cy-navbar>

    <view
      class="flex align-item-center justify-content-center"
      v-show="personList.length < 1"
    >
      <image
      ...
      <view class="flex flex-direction-column align-item-center">
        ...
        >
          ...
          <view
            ...
            class="select-box flex align-item-center justify-content-center"
          >
            <u-icon name="checkbox-mark" color="#FFFFFF" size="22"></u-icon>
          </view>
          <view class="info-box flex align-item-center pr-2 pl-2 border-box">
            <view
              class="image-box flex align-item-center justify-content-centerq"
            >
            ...
            <view class="info ml-3 flex flex-direction-column">
              <view class="flex align-item-end justify-content-between">
                ...
                <image
                  mode="widthFix"
                  class="trumpet"
                  :src="`${imageBaseUrl}/ai_person_01.png`"
                ></image>
              </view>
              ...
              <view class="flex number-box mt-2 align-item-center t-size-24">
                <image
                  class="mr-3"
                  mode="widthFix"
                  :src="`${imageBaseUrl}/ai_person_02.png`"
                ></image>
